    ...
    return(
        <div className="mx-4 lg:mx-8">
            ...
            <div className="lg:grid lg:grid-cols-8">
                ...
                <div className="flex justify-around my-8 lg:flex-col lg:ml-56 lg:my-4" >
                    <div className="flex flex-col items-center lg:mb-10">
                    <h2 className="inline mb-4 text-2xl font-bold text-gray-900 trackinlg-tight lg:text-6xl">
                    2k+</h2>
                    <span className="text-xl font-semibold lg:text-2xl" >Villages</span>
                    </div>
                    
                    <div className="flex flex-col items-center lg:mb-10">
                    <h2 className="inline mb-4 text-2xl font-bold text-gray-900 trackinlg-tight lg:text-6xl">
                    15L+</h2>
                    <span className="text-xl font-semibold lg:text-2xl" >Childrens</span>
                    </div>
                    
                    <div className="flex flex-col items-center lg:mb-10">
                    <h2 className="inline mb-4 text-2xl font-bold text-gray-900 trackinlg-tight lg:text-6xl">
                    400+</h2>
                    <span className="text-xl font-semibold lg:text-2xl" >Projects</span>
                    </div>
                </div>
            </div>
        </div>
